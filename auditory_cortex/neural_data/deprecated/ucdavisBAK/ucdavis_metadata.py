...
class UCDavisBAKMetaData(BaseMetaData):
    def __init__(self):
        ...
        self.timit_meta = UCDavisBAKMetaData.read_stim_meta(self.timit_meta_file)
        ...
        self.mVocs_meta = UCDavisBAKMetaData.read_stim_meta(self.mVocs_meta_file)
    ...
    def get_stim_audio(self, stim_id, mVocs=False):
        ...
        if stim_id not in stim_audios:
            ...
            stim_audio = UCDavisBAKMetaData.read_wfm(stim_filepath)
