...
DATASET_NAME = NEURAL_DATASETS[2]

@register_metadata(DATASET_NAME)
class UCDavisActMetaData(BaseMetaData):
    def __init__(self):
        ...
        self.timit_meta = UCDavisActMetaData.read_stim_meta(self.timit_meta_file)
        ...
        self.mVocs_meta = UCDavisActMetaData.read_stim_meta(self.mVocs_meta_file)
    ...
    def get_stim_audio(self, stim_id, mVocs=False):
        ...
        if stim_id not in stim_audios:
            ...
            stim_audio = UCDavisActMetaData.read_wfm(stim_filepath)
